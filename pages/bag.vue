<template>
  <div class="container">
        ...
        <div class="page-item">
          <div class="row item">
            <div class="content-principal col col-md">
              <img src="../img/product2copy.png" alt="" />
            </div>
            <div class="content-principal col col-md">
              <div class="content">
        ...
        <div class="content-form">
          <form action="" class="mt-5">
            <div class="form-group">
              ...
              <div class="row">
                <div class="col-12 col-sm-12 col-md-12 col-lg-2 col-xl-2 mt-4">
    ...
    <div class="after_prev">
      <button class="btn_before" v-if="before" type="button" @click="voltar">Voltar</button>
      <button class="btn_after" v-if="after" type="button" @click="proximo">Proximo</button>
      <button class="btn_confirm" v-if="confirmBag" type="button" @click="createOrder">Confirmar pedido</button>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    sumTotal(discount_type) {
        ...
        this.product.descount =  (this.product.quantity * this.product.unit_price * this.product.cupom) / 100; 
        this.product.total_price = priceTotal - (this.product.quantity * this.product.unit_price * this.product.cupom) / 100;
